...
export const seoIssues: SeoIssue[] = [
  ...
  { id: "BUG-009", severity: "high", title: "No automated crawl regression suite", url: "/sitemap.xml", evidence: "There is no CI check for internal links, HTTP status, assets, or schema.", recommendation: "Add a sitemap and same-origin crawler to CI.", status: "fixed" },
  { id: "BUG-010", severity: "high", title: "Search Console and GA4 are not connected", url: "/admin/seo", evidence: "GA4 tag G-EMKR761SSQ is present in root layout; Search Console property verification still needed.", recommendation: "Verify Search Console property server-side and label source/freshness for every metric.", status: "acknowledged" },
