...
const courseData = {
    ...
    b1: { title:'The Hacking Bible: Complete Guide', category:'Hacking Book', img:'eduimages/The Hacking Bible Complete Guide.jpeg', desc:'The ultimate hacking reference book. Covers everything from basic concepts to advanced techniques.', level:'Advanced', duration:'PDF Book', students:'5,200', rating:'4.8', price:1, oldPrice:99, includes:['PDF format (450+ pages)','Practical examples','Step-by-step guides','Bonus cheat sheets'] },
    b2: { title:'Trading Psychology: Master Your Mind', category:'Trading Book', img:'eduimages/Trading Psychology Master Your Mind.jpeg', desc:'Master the psychology of trading. Learn to control emotions and build discipline.', level:'All Levels', duration:'PDF Book', students:'3,800', rating:'4.7', price:1, oldPrice:79, includes:['PDF format (280+ pages)','Case studies','Self-assessment tools','Bonus worksheets'] },
    b3: { title:'Python Crash Course: Complete Guide', category:'Programming Book', img:'eduimages/Python Crash Course Complete Guide.jpeg', desc:'Learn Python programming through this comprehensive guide. Perfect for beginners.', level:'Beginner', duration:'PDF Book', students:'12,000', rating:'4.9', price:1, oldPrice:99, includes:['PDF format (380+ pages)','Code examples','Practice exercises','Project ideas'] },
    ...
    t5: { title:'Mindfluential Trading: Psychology & Strategy', category:'Trading Book', img:'eduimages/Mindfluential Trading Psychology & Strategy.jpeg', desc:'Master the mental game of trading. Comprehensive guide to trading psychology and strategies.', level:'All Levels', duration:'PDF Book', students:'4,200', rating:'4.8', price:1, oldPrice:99, downloadUrl:'https://www.mediafire.com/file/4fo3qqyonf9fg9o/3._Mindfluential_Trading.pdf/file', includes:['PDF format (320+ pages)','Real trader case studies','Emotional control techniques','Trading plan templates'] }
};
