...
const courseData = {
    ...
    b1: { title:'The Hacking Bible: Complete Guide', category:'Hacking Book', img:'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=600&h=300&fit=crop', desc:'The ultimate hacking reference book. Covers everything from basic concepts to advanced penetration testing techniques. A must-have for every security professional.', level:'Advanced', duration:'PDF Book', students:'5,200', rating:'4.8', reviews:'890', price:0, oldPrice:0, includes:['PDF format (450+ pages)','Practical examples','Step-by-step guides','Bonus cheat sheets','Free updates for life','Instant download'] },
    b2: { title:'Trading Psychology: Master Your Mind', category:'Trading Book', img:'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=600&h=300&fit=crop', desc:'Master the psychology of trading. Learn to control emotions, build discipline, and develop the mindset of successful traders. Based on research and real trader experiences.', level:'All Levels', duration:'PDF Book', students:'3,800', rating:'4.7', reviews:'650', price:0, oldPrice:0, includes:['PDF format (280+ pages)','Case studies','Self-assessment tools','Bonus worksheets','Instant download'] },
    b3: { title:'Python Crash Course: Complete Guide', category:'Programming Book', img:'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=600&h=300&fit=crop', desc:'Learn Python programming through this comprehensive guide. Perfect for beginners. Covers fundamentals, OOP, data structures, and practical projects.', level:'Beginner', duration:'PDF Book', students:'12,000', rating:'4.9', reviews:'2,100', price:0, oldPrice:0, includes:['PDF format (380+ pages)','Code examples','Practice exercises','Project ideas','Instant download','Free updates'] },
    d1: { title:'UI/UX Design Complete Course', category:'Design', img:'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&h=300&fit=crop', desc:'Master UI/UX design from wireframes to high-fidelity prototypes. Learn Figma, Adobe XD, user research, and design thinking. Build a professional portfolio.', level:'Beginner', duration:'38 hours', students:'20,000', rating:'4.8', reviews:'1,800', price:199, oldPrice:499, includes:['38 hours of HD video','Figma & Adobe XD','10 design projects','Certificate of completion','Lifetime access','Portfolio templates','Design system guide'] },
